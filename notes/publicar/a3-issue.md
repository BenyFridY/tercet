Proposal below — structure mirrors `specs/extensions/extension-offer-and-receipt.md`.
We run a reference implementation (issuer + verifier, level 2) in an instrumented
buyer; happy to PR the spec file into `specs/extensions/` if there's interest.
